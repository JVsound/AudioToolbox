function svgPath = generateclassdiagramsvg(svgPath, options)
    ...
    enclosureBox = struct("x", 470, "y", 440, "w", 360, "name", "comp.Enclosure", "stereo", "abstract", ...
        ...
        {"Methods", {plain("ta(f,ra)"), abstract("tae, tarad (f,ra)"), ...
            abstract("diaphragm2RadiatedVolumeVelocity(f,ra)"), ...
            static("zarad(...)"), ...
            static("struve(...)")}}}});
    ...
    closedBoxBox = struct("x", 40, "y", subclassY, "w", 285, "name", "comp.ClosedBox", "stereo", "", ...
        ...
        {"Methods", {plain("zaradf, zacbr, tae, tarad"), plain("diaphragm2RadiatedVolumeVelocity")}}}});
    ...
    feaEnclosureBox = struct("x", 910, "y", subclassY, "w", 330, "name", "comp.FeaEnclosure", "stereo", "", ...
        ...
        {"Methods", {plain("tae, tarad"), plain("diaphragm2RadiatedVolumeVelocity"), ...
